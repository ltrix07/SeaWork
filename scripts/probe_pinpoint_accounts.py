...
CANDIDATES = [
    ...
    "carnival", "carnivalcruiseline", "princess", "princesscruises",
    "cunard", "pocruises", "aida", "aidacruises", "costa", "costacruises",
    "seabourn", "hollandamerica",
    # Royal Caribbean Group
    "royalcaribbean", "royalcaribbeangroup", "celebritycruises", "silversea",
    # Norwegian Cruise Line Holdings
    "norwegian", "ncl", "norwegiancruiseline", "oceania", "oceaniacruises",
    "regent", "regentsevenseas",
    # Independent cruise and expedition
    "msccruises", "disneycruiseline", "virginvoyages", "viking", "vikingcruises",
    "hurtigruten", "windstar", "windstarcruises", "explora", "exploraJourneys",
    "ponant", "azamara", "marella", "fredolsen", "swanhellenic", "atlasocean",
    "scenic", "emeraldcruises", "seadream", "lindblad", "auroraexpeditions",
    "quarkexpeditions", "saga", "ambassadorcruiseline",
    # Ship management and crewing
    "vships", "angloeastern", "bernhardschulte", "columbiashipmanagement",
    "wallem", "fleetmanagement", "synergymarine", "oldendorff", "maersk",
    "stenaline", "dfds", "wallenius", "hapaglloyd", "thome", "zodiacmaritime",
]
